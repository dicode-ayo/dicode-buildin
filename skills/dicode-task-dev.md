...
the `dicode secrets list` CLI, read this skill and dicode-core's
`tasks/examples/*` for the
...
Full reference: [docs/concepts/suspendable-tasks.md](https://github.com/dicode-ayo/dicode-core/blob/main/docs/concepts/suspendable-tasks.md).
...
philosophy via dicode-core's `tasks/sdk_test.py`, but it's a PEP 723 script
with a couple of non-obvious requirements around how it's invoked. See
[docs/concepts/testing.md § Python](https://github.com/dicode-ayo/dicode-core/blob/main/docs/concepts/testing.md#python)
and [tasks/examples/hello-python/task.test.py](https://github.com/dicode-ayo/dicode-core/blob/main/tasks/examples/hello-python/task.test.py)
before writing one.)
