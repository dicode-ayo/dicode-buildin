...
// ── systray import ───────────────────────────────────────────────────────────
//
// TODO(#59): Confirm version tag at https://deno.land/x/systray before release.
// If deno.land/x/systray is unavailable, the alternative is to shell out to the
// getlantern/systray helper directly via Deno.Command and implement the
// stdin/stdout JSON protocol manually (see the helper's README for the schema).

// @deno-types="https://deno.land/x/systray@v0.0.2/mod.ts"
import Systray, { type MenuItem } from "https://deno.land/x/systray@v0.0.2/mod.ts";
