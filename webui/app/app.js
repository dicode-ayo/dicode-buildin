...
import { navigate, render, route } from "./lib/router.js";
...
route(/^\/config$/, () => {
  app.innerHTML = "<dc-config></dc-config>";
});
route(/^\/secrets$/, () => {
  app.innerHTML = "<dc-secrets></dc-secrets>";
});
route(/^\/security$/, () => {
  app.innerHTML = "<dc-security></dc-security>";
});
route(/^\/sources$/, () => {
  app.innerHTML = "<dc-sources></dc-sources>";
});
route(/^\/metrics$/, () => {
  app.innerHTML = "<dc-metrics></dc-metrics>";
});
...
route(/^\/ui-kit$/, () => {
  app.innerHTML = "<dc-ui-kit-demo></dc-ui-kit-demo>";
});
route(/^\/$/, () => {
  app.innerHTML = "<dc-task-list></dc-task-list>";
});
