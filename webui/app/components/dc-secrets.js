...
class DcSecrets extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      ${this._status
        ? html`
          <p style="color:red;margin-bottom:var(--dicode-space-md)">${this
            ._status}</p>
        `
        : ""}
      <table>
        ...
        ? html`
          <tr>
            <td colspan="2" style="text-align:center;color:var(--dicode-muted)">
              No secrets stored.
            </td>
          </tr>
        `
